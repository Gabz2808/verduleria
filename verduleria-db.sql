...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "USER_JAVA"."V_INVENTARIO_PRODUCTOS" ("ID_INVENTARIO", "ID_PRODUCTO", "STOCK", "NOMBRE_PRODUCTO") AS 
  SELECT I.ID_INVENTARIO, I.ID_PRODUCTO, I.STOCK, P.NOMBRE AS NOMBRE_PRODUCTO
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Trigger ACTUALIZARSTOCKCOMPRA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "USER_JAVA"."ACTUALIZARSTOCKCOMPRA" 
...
END;
/
ALTER TRIGGER "USER_JAVA"."ACTUALIZARSTOCKCOMPRA" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger ACTUALIZARTOTALCOMPRA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "USER_JAVA"."ACTUALIZARTOTALCOMPRA" 
...
END;
/
ALTER TRIGGER "USER_JAVA"."ACTUALIZARTOTALCOMPRA" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_JAVA"."COMPRAS" MODIFY ("ID_COMPRA" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DETALLE_COMPRAS
--------------------------------------------------------

  ALTER TABLE "USER_JAVA"."DETALLE_COMPRAS" MODIFY ("ID_DETALLE_COMPRA" NOT NULL ENABLE);
--------------------------------------------------------
